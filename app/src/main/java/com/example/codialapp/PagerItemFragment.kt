...
import com.example.codialapp.databinding.FragmentPagerItemBinding
...
class PagerItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        for (i in myDbHelper.getGroups()){
            if (i.group == Data.num1 && i.start_group == 1) list.add(i)
        }
        rvAdapterGroups = RvAdapterGroups(list, object : ClickGroup{
